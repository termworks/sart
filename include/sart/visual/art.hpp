...
namespace sart {
    using visual::Art;
    using visual::ArtError;
    using visual::ArtErrorCode;
    using visual::decode_utf8;
    using visual::encode_utf8;
    using visual::Layout;
    using visual::layout;
    using visual::max_art_bytes;
    using visual::max_art_height;
    using visual::max_art_width;
    using visual::Size;
} // namespace sart
