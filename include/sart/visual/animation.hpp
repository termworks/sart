...
namespace sart {
    using visual::AnimatedCell;
    using visual::AnimationMetadata;
    using visual::AnsiColor;
    using visual::append_ansi_color;
    using visual::cell_color_at;
    using visual::cell_hash;
    using visual::ColoredGlyph;
    using visual::normalized_hash;
    using visual::smoothstep;
} // namespace sart
