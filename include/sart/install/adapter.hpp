...
namespace sart {
    using install::adapter_ids;
    using install::adapter_metadata;
    using install::adapter_name;
    using install::adapter_pair;
    using install::adapter_pairs;
    using install::AdapterId;
    using install::AdapterKind;
    using install::AdapterMetadata;
    using install::AdapterPairMetadata;
    using install::PasswordBrokerStatus;
    using install::SupportStatus;
} // namespace sart
