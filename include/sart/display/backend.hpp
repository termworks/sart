...
namespace sart {
    using display::Cell;
    using display::Color;
    using display::Dimensions;
    using display::DisplayBackend;
    using display::DisplayError;
    using display::DisplayErrorCode;
    using display::DisplayState;
    using display::InputEvent;
    using display::maximum_scene_cells;
    using display::owns_resources;
    using display::RestoreMode;
    using display::Scene;
    using display::SceneError;
    using display::SceneErrorCode;
    using display::Style;
    using display::validate_sensitive_text;
} // namespace sart
