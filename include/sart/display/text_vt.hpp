...
namespace sart {
    using display::encode_scene;
    using display::LinuxVtIo;
    using display::maximum_linux_vt;
    using display::minimum_linux_vt;
    using display::TextVtBackend;
    using display::TextVtConfig;
    using display::VtDeallocation;
    using display::VtIo;
    using display::VtSelection;
    using display::VtSelectionKind;
} // namespace sart
