...
namespace bootart::embedded {
    ...
    inline constexpr std::string_view default_art = R"BOOTART(              ▄▄▄▄▄▄▄▄              
         ▄▄██████████████▄▄         
      ▄██████████████████████▄      
    ▄██████████████████████████▄    
  ▄█▀▄████████████████████████▄▀█▄  
 ...
 ██       ▀██▀████████▀██▀       ██ 
  ██        ▀█ ██████ █▀        ██  
   ██▄        █ ████ █        ▄██   
    ...
    inline constexpr std::string_view small_art = R"BOOTART( ___  ____ ___  ____ ___ 
|__] |  |  |  |__|  |  
|__] |__|  |  |  |  |  
)BOOTART";
    ...
    inline constexpr std::string_view default_config = R"BOOTART(schema=bootart.config
version=1
